 ...
 */
package com.PortfolioFR.PortfolioFR.Security.Entity;
...
public class UsuarioPrincipal implements UserDetails {
    ...
    public static UsuarioPrincipal build(User usuario) {
        ...
        return new UsuarioPrincipal(usuario.getNombre(), usuario.getNombreUser(), usuario.getEmail(), usuario.getPassword(), authorities);
    }
